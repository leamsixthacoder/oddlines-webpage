...
OD.i18n = {
  en:{
    ...
    slip_empty:"Your bet slip is empty", slip_hint:"Tap any odds to add a selection.",
    stake:"Stake", potential:"Potential return", selections:"selections", combined:"Combined odds",
    continue_app:"Continue in app", clear_slip:"Clear",
    offers:"Offers", join:"Join", login:"Log In", in_play:"In-Play", casino:"Casino", promotions:"Promotions",
    trending:"Trending", most_used:"Most Used", az:"A\u2013Z", view_all:"View all", view_more_legs:"more legs",
    bet_boost:"BET BOOST", super_boost:"SUPER BOOST", early_payout:"EARLY PAYOUT", returns:"returns",
    player_markets:"Player Markets", show_more:"Show more", boosts_today:"Boosts of the day",
    builder_lead:"Build your own bet — stack player markets into one price", live_now:"Live now",
    promo_eyebrow:"New customer offer", promo1_t:"Get up to $30 in bet credits", promo1_c:"Join now",
    promo2_eyebrow:"More boosts than ever", promo2_t:"World Cup 2026 daily reveal", promo2_c:"Reveal offer",
    promo3_eyebrow:"Pick your results", promo3_t:"Win up to $250,000", promo3_c:"Compete now",
    promo_terms:"18+. T&Cs, time limits and exclusions apply. Please play responsibly.",
  ...
  es:{
    ...
    slip_empty:"Tu boleto está vacío", slip_hint:"Toca cualquier cuota para añadir una selección.",
    stake:"Importe", potential:"Retorno potencial", selections:"selecciones", combined:"Cuota combinada",
    continue_app:"Continuar en la app", clear_slip:"Vaciar",
    offers:"Ofertas", join:"Únete", login:"Entrar", in_play:"En Vivo", casino:"Casino", promotions:"Promociones",
    trending:"Tendencias", most_used:"Más usados", az:"A\u2013Z", view_all:"Ver todo", view_more_legs:"selecciones más",
    bet_boost:"CUOTA MEJORADA", super_boost:"SÚPER CUOTA", early_payout:"PAGO ANTICIPADO", returns:"devuelve",
    player_markets:"Mercados de Jugador", show_more:"Ver más", boosts_today:"Cuotas del día",
    builder_lead:"Crea tu apuesta — combina mercados de jugador en un solo precio", live_now:"En vivo ahora",
    promo_eyebrow:"Oferta nuevos clientes", promo1_t:"Hasta $30 en créditos de apuesta", promo1_c:"Únete ya",
    promo2_eyebrow:"Más cuotas que nunca", promo2_t:"Mundial 2026 revelación diaria", promo2_c:"Revelar oferta",
    promo3_eyebrow:"Elige tus resultados", promo3_t:"Gana hasta $250,000", promo3_c:"Compite ya",
    promo_terms:"18+. Aplican T&C, límites de tiempo y exclusiones. Juega responsablemente.",
